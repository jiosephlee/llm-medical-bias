...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name =  "./llama_3_1_8B_+_KTAS_25", #./llama_3_1_8B_ESI_Handbook_10",
...
test_dataset = dataset.map(lambda x: prompts.format_instruction_prompt_for_finetuning(x, EOS_TOKEN, dataset='triage-ktas',split='test'))
...
for i, sample in tqdm(enumerate(test_dataset)):
    ...
    true_acuity = sample['KTAS_expert']
...
output_filepath = '../results/Triage-KTAS/Triage-KTAS-Llama_3.1'
